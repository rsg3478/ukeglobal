...
!(function (t, e) {
    ...
    var c = {
        ...
        jQueryDetection: function () {
            if ("undefined" == typeof e) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstr" + "ap's JavaScript.");
        ...
        D = (function () {
            function t(t, e) {
                (this._isTransitioning = !1),
                    (this._element = t),
                    (this._config = this._getConfig(e)),
                    (this._triggerArray = [].slice.call(document.querySelectorAll('[data-toggle="collapse"][href="#' + t.id + '"],[data-toggle="collapse"][data-t' + 'arget="#' + t.id + '"]')));
    ...
    var U = "tooltip",
        ...
        X = {
            animation: !0,
            template: '<div class="tooltip" role="tooltip"><div class="arrow"></div><div class="toolt' + 'ip-inner"></div></div>',
            trigger: "hover focus",
            title: "",
            delay: 0,
            html: !1,
    ...
    var J = "popover",
        ...
        tt = a(
            ...
            {},
            {
                ...
                trigger: "click",
                content: "",
                template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popove' + 'r-header"></h3><div class="popover-body"></div></div>',
            }
        ),
