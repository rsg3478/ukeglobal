...
?>
<img class="bannerimg" src="<?php echo UKE_IMG_URL?>/menu01/banner01.png"/>
<?php 
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="mx-auto mb-9 my-lg-9">
                    <h3>회사소개</h3>
                    <p>회사소개회사소개회사소개회사소개회사소개회사소개회사소개회사소개회사소개회사소개회사소개회사소개회사소개회사소개회사소개회사소개회사소개회사소개회사소개</p>
                </div>
            </div>
        </div>
    </div>
